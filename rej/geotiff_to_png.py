...
# TODO: this should be invoked by backend only if a png needs to be generated.
# Will continue to just use a sample png for testing purposes, but the tif rasterio
# code must be fixed.
